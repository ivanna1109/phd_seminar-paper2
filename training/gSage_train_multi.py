...
from models.gSage_features import GraphSageMultiClass as GraphSageModel
...
print("GSage Training (Graphs + Global Features)..............................................")
...
final_dir = '/home/ivanam/BIO-Info/bio_info/multi_seminar2/training/results_with_features/gSage'
with open(f'{final_dir}/model_summary-e{num_epoch}.txt', 'w') as f:
...
history_df.to_csv(f'{final_dir}/gSage_model-e{num_epoch}.csv', index=False)

print("Cuvanje tezina modela..")
model.save_weights(f'{final_dir}/gSage_model-e{num_epoch}.h5')

output_file_path = f"{final_dir}/gSage_test_results-e{num_epoch}.txt"
