...
from models.gin_features import GINMultiClass as GINModel
...
#Graphs + global features dataset
...
print("GIN Training (Graphs Only)..............................................")
...
hidden_units = 256  # Skriveni slojevi gin
dense_units = [62, 128]
dropout_rate = 0.23
...
model.compile(tf.keras.optimizers.Adam(learning_rate=0.001023), #lr po optuna proracunu
...
final_dir = '/home/ivanam/BIO-Info/bio_info/multi_seminar2/training/results_with_features/gin'
with open(f'{final_dir}/model_summary-gin_e{num_epoch}.txt', 'w') as f:
    model.summary(print_fn=lambda x: f.write(x + '\n'))
print("Zavrseno pisanje u fajl.")

print("Pisemo history treninga..")
history_df = pd.DataFrame(history.history)
history_df.to_csv(f'{final_dir}/gin_history-e{num_epoch}.csv', index=False)

print("Cuvanje tezina modela..")
model.save_weights(f'{final_dir}/gin_model-e{num_epoch}.h5')

output_file_path = f"{final_dir}/gin_test_results-e{num_epoch}.txt"
